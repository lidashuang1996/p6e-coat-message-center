...
//
//    @Override
//    public LauncherData execute(ShortMessageConfigModel config, TemplateModel template, List<String> recipients) {
//        if (config == null) {
...
//     */
//    private com.aliyun.dysmsapi20170525.Client getAliYunClient(ShortMessageConfigModel config) throws Exception {
...
//     * @throws Exception 异常对象
//     */
//    private synchronized com.aliyun.dysmsapi20170525.Client createAliYunClient(ShortMessageConfigModel config) throws Exception {
//        final String id = config.applicationKeyId();
//        final String domain = config.applicationDomain();
...
//            ShortMessageConfigModel config,
