...
@ConditionalOnMissingBean(
        value = DictionaryTemplateVariableParser.class,
        ignored = DictionaryTemplateVariableParser.class
)
public class DictionaryTemplateVariableParser implements TemplateVariableParser {
